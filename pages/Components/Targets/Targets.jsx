...
const Targets = ()=>{
    const dataBox1 = ["Express backend","Database : Mysql, Redis, MongoDb","Fluent in Amazon's Object Storage S3","Database design and implementation"];
            ...
            <Grid container direction="row" justifyContent="center" alignItems="center" sx={{mt:"10px",mb:"50px"}}>
                <Grid item container xs={12} md={8} justifyContent="center" alignItems="center" spacing={2} >
                    <Grid item xs={12} md={6} >
                        <BoxData data={dataBox1} title="Web specialties" />
                    </Grid>
                    <Grid item xs={12} md={6}>
